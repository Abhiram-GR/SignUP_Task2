...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2023 at 01:59 PM
...
(5, '2023_06_27_053647_task2', 1),
(6, '2023_06_27_071846_user', 2),
(7, '2023_06_27_071921_user', 3),
(8, '2023_06_27_072243_create_us_table', 4),
(9, '2023_06_27_072440_us', 5),
(10, '2023_06_27_073346_create_people_table', 6),
(15, '2014_10_12_000000_create_users_table', 7),
(16, '2014_10_12_100000_create_password_reset_tokens_table', 7),
(17, '2019_08_19_000000_create_failed_jobs_table', 7),
(18, '2019_12_14_000001_create_personal_access_tokens_table', 7),
(19, '2023_06_27_081653_y', 8),
(20, '2023_06_28_051054_countries', 9),
(21, '2023_06_28_051429_state', 10),
(22, '2023_06_28_052500_create_states_table', 11),
(23, '2023_06_28_053504_create_userdatas_table', 12);
...
INSERT INTO `userdata` (`id`, `firstname`, `lastname`, `email`, `password`, `country_id`, `state_id`, `created_at`, `updated_at`) VALUES
(1, 'ABHI', 'R', 'abhiram.r@orisys.in', NULL, 1, 42, '2023-06-28 05:50:18', '2023-06-28 05:50:18'),
(2, 'Safna', 'K', 'abhiram.r@orisys.in', NULL, 1, 42, '2023-06-28 08:16:53', '2023-06-28 08:16:53'),
(3, 'ABHI', 'R', 'abhiram.r@orisys.in', NULL, 1, 42, '2023-06-28 08:20:03', '2023-06-28 08:20:03'),
(4, 'Sonu', 'R', 'abhiram.r@orisys.in', NULL, 1, 42, '2023-06-28 08:22:13', '2023-06-28 08:22:13'),
(5, 'Abhiram', 'R', 'abhiram.r@orisys.in', NULL, 14, 282, '2023-06-28 08:32:12', '2023-06-28 08:32:12'),
(6, 'abhi', 'r', 'abhiram.r@orisys.in', NULL, 2, 74, '2023-06-28 11:46:59', '2023-06-28 11:46:59'),
(7, 'Abhi', 'r', 'abhiram.r@orisys.in', NULL, 1, 43, '2023-06-28 11:49:41', '2023-06-28 11:49:41'),
(8, 'ABHI', 'R', 'grp.abhiram@gmail.com', NULL, 3, 111, '2023-06-28 11:50:49', '2023-06-28 11:50:49');
...
ALTER TABLE `userdata`
  ADD PRIMARY KEY (`id`),
  ADD KEY `userdata_country_id_foreign` (`country_id`),
  ADD KEY `userdata_state_id_foreign` (`state_id`);
...
--
ALTER TABLE `userdata`
  ADD CONSTRAINT `userdata_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `userdata_state_id_foreign` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`) ON DELETE CASCADE;
COMMIT;
