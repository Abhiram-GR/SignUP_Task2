...
class SignupTask2Controller extends Controller
{
    ...
    public function saveFormData(Request $request)
    {
        ...
        $sql = "INSERT INTO userdata (firstname, lastname, email, country_id, state_id, created_at, updated_at)
        ...
        try {
            ...
            $templatePath = storage_path('app/email/template.html');
            $template = file_get_contents($templatePath);
    
            // Customize the template with dynamic values
            $template = str_replace('{username}', $validatedData['firstName'], $template);
